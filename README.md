...
- Аргументы запуска. Собираем фикстуры, марки, и другую полезную информацию для отладки
  - --co - собрать коллекцию тестов
  - -k - выполнить тест у которых совпадает подстрока
  - -m - выполнить тесты у которых маркировка 
  - --markers
  - --fixtures
  - --durations=10 - вывод статистики 10 самыз медленных тестов
  - -v
  - -l (--showlocals)
  - --setup-plan
